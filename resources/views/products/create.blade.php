    ...
    <div class="max-w-xl mx-auto bg-white dark:bg-gray-800 p-6 rounded-md shadow">
        ...
        <form action="{{ url('products/new') }}" method="POST" enctype="multipart/form-data">
            ...
            <div>
                ...
                <textarea id="description" name="description" class="w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-white" rows="5"></textarea>
            </div>
